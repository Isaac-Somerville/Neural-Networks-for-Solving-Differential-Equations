...
# ranges = [[0,3]]  # fails 
# ranges = [[0,1.5], [0,3]]  # succeeds 
# ranges = [[0,1],[0,2],[0,3]]  # succeeds  

###### TRAINNG ON NON-INTERSECTING SUBINTERVALS, STARTING FROM 0
# ranges = [[0,1.5], [1.5,3]] # succeeds but suboptimal solution
# ranges = [[0,1],[1,2],[2,3]] # succeeds but suboptimal solution

###### TRAINNG ON NON-INTERSECTING SUBINTERVALS, THEN FULL INTERVAL, STARTING FROM 0
# ranges = [[0,1.5], [1.5,3], [0,3]] # succeeds 
# ranges = [[0,1],[1,2],[2,3],[0,3]] # succeeds 

###### TRAINING ON SUBINTERVALS OF INCREASING SIZE, STARTING FROM 3
# ranges = [[1.5,3], [0,3]]  # fails 
# ranges = [[2,3],[1,3],[0,3]]  # fails 
# ranges = [[2.25,3],[1.5,3],[0.75,3],[0,3]] # fails 

###### TRAINNG ON NON-INTERSECTING SUBINTERVALS, THEN FULL INTERVAL, STARTING FROM 3
# ranges = [[1.5,3], [0,1.5], [0,3]] # succeeds 
# ranges = [[2,3],[1,2],[0,1],[0,3]] # succeeds 

###### TRAINNG ON NON-INTERSECTING SUBINTERVALS, STARTING FROM 3
# ranges = [[1.5,3], [0,1.5]] # succeeds
