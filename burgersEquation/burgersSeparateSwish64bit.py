...
#############
# Swish activation function, train for u(x,t), then lambda_i
...
try: # load saved network if possible
    checkpoint = torch.load('burgersSeparateSwish64bit.pth')
...
while epoch < 100000:
    ...
    torch.save(checkpoint, 'burgersSeparateSwish64bit.pth')
    print("model saved")
